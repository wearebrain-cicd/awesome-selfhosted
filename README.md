...
- [Sinas](https://sinas.co/) - Open source platform for building and managing AI agent workflows with tools, scheduling, webhooks, isolated code execution, and role based access control. ([Source Code](https://github.com/sinas-platform/sinas)) `AGPL-3.0` `Docker`
...
- [Secluso](https://secluso.com) - Private DIY home security camera system for Raspberry Pi, with end-to-end encrypted remote access and mobile apps for live video, alerts, and recording playback. ([Source Code](https://github.com/secluso/core)) `GPL-3.0` `Rust/deb`
